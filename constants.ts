...
/**
 * Using High Quality Official Icons
 * Blender logo from Wikimedia for maximum reliability and "official" look.
 */
export const SOFTWARE_ICONS: Record<Software, string> = {
  ...
  [Software.BLENDER]: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Blender_logo_no_text.svg/512px-Blender_logo_no_text.svg.png"
};

/**
 * Brand Identity Mapping for Fallbacks
...
/**
 * Color logic for borders (strokes) as requested:
 * Premiere: Purple
 * Final Cut: Red
 * DaVinci: Blue
 * Blender: Yellow
...
export const SOFTWARE_COLORS: Record<Software, string> = {
  [Software.PREMIERE]: "border-purple-600 bg-purple-600/10 text-purple-200",
  [Software.FINAL_CUT]: "border-red-600 bg-red-600/10 text-red-100",
  [Software.DAVINCI]: "border-blue-600 bg-blue-600/10 text-blue-200",
  [Software.BLENDER]: "border-yellow-500 bg-yellow-500/10 text-yellow-100"
};
